...
**Project:** Star Community
**Generated:** 2026-04-09 22:03:58
...
| Secondary | `#69c0ff` | `--color-secondary` |
| CTA/Accent | `#22C55E` | `--color-cta` |
| Background | `#FAFAFA` | `--color-background` |
| Text | `#1a1a1a` | `--color-text` |

**Color Notes:** Community blue + join green (禁止紫色)
